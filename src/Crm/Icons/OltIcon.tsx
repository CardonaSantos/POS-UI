...
type OltIconProps = React.SVGProps<SVGSVGElement> & {
  size?: number;
};

export function OltIcon({ size = 16, className, ...props }: OltIconProps) {
  return (
    <svg
