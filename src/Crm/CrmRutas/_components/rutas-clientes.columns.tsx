  ...
  return [
...

    {
      ...
      cell: ({ row }) => {
        ...
        if (!nombre) {
          return <EmptyText>Sin nombre</EmptyText>;
        }
...

    {
      ...
      cell: ({ row }) => {
        ...
        if (!zona) {
          return <EmptyText>Sin zona</EmptyText>;
        }
...

    {
      ...
      cell: ({ row }) => {
        ...
        if (!sector) {
          return <EmptyText>Sin sector</EmptyText>;
        }
...

    {
      ...
      cell: ({ row }) => {
        ...
        if (!municipio) {
          return <EmptyText>Sin municipio</EmptyText>;
        }
...

    {
      ...
      cell: ({ row }) => {
        ...
        if (!estado) {
          return <EmptyText>Sin estado</EmptyText>;
        }
